...
const Cart = () => {
    ...
    const { cartItems, products,currency,removeFromCart,getCartCount,updateCartItem,navigate,getCartAmount,axios,user,setCartItems } = useAppContext();
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                {address.map((address,index)=>(<p key={index} onClick={() => {setSelectedAddress(address); setShowAddress(false)}} className="text-gray-500 p-2 hover:bg-gray-100">
