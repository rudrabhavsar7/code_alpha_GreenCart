            ...
            {order.items.map((item, index) => {
              return (
                <div
                  ...
                  } border-grey-300 flex flex-col md:flex-row justify-between md:items-center p-4 py-5 md:gap-16 w-full max-w-4xl`}
                >
                  ...
                  <div className="flex flex-col justify-center md:ml-8 mb-4 md:mb0">
